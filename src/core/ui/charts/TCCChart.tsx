...
export const TCCChart: React.FC<TCCChartProps> = ({
  ...
  }, [ratedCurrent, faultCurrent, activeCurve, currentMult, currentTripTime, magneticBand, calcTripTime, selectedOEM, trail, isTripped, dimensions]);
