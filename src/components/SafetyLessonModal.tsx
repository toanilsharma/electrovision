...
export const SafetyLessonModal: React.FC<SafetyLessonModalProps> = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center lg:justify-start p-3 sm:p-4 lg:pl-6 pointer-events-none overflow-y-auto">
          ...
          <motion.div
            ...
            className={cn(
              "relative z-10 w-full max-w-[560px] lg:max-w-[calc(100vw-530px)] xl:max-w-[calc(100vw-590px)] bg-slate-950 rounded-2xl border-2 shadow-[0_20px_50px_rgba(0,0,0,0.95)] overflow-hidden flex flex-col my-auto pointer-events-auto",
              isPPESafe 
